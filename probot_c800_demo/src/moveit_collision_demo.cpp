...
int main(int argc, char **argv)
{
    ...
    add_object_primitive.dimensions[0] = 1;
    add_object_primitive.dimensions[1] = 0.05;

    // 设置障碍物的位置
    geometry_msgs::Pose add_object_pose;
    add_object_pose.orientation.w = 1.0;
    add_object_pose.position.x =  0.4;
    add_object_pose.position.y =  0;
    add_object_pose.position.z =  0.5;
    ...
    // 机器人运动目标位置
    double targetPose[6] = {-0.9978491067886353, -0.419870525598526, -1.6761932373046875, 0.3421085774898529, 2.0280234813690186, -0.3581558167934418};
