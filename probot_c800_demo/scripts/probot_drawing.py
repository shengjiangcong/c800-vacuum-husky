...
class MoveItCircleDemo:
    def __init__(self):
        ...
        star_pose.pose.position.x = 0.381226
        star_pose.pose.position.y = -0.152108
        star_pose.pose.position.z = 0.364821
        star_pose.pose.orientation.x = 0.690142
        star_pose.pose.orientation.y = -0.00017802
        star_pose.pose.orientation.z = 0.0
        star_pose.pose.orientation.w = 0.723674
